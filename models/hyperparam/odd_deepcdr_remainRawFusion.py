    ...
    def forward(self, source, target=None, mark=None):
        ...
        if self.training == True:
            ...
            target_x_fusion_reg_mean = torch.Tensor(np.array(
                [target_x_fusion_reg_0_reweight, target_x_fusion_reg_1_reweight]).sum(0))/2

            return target_x_fusion_reg_0_reweight, target_x_fusion_reg_1_reweight, target_x_fusion_reg_mean
